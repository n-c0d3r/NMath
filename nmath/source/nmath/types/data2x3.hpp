...
namespace nmath {
    ...
    template<typename F_entry__ = NMATH_DEFAULT_FP_TYPE, typename F_flag__ = F_data_default_flag>
    using TPA_data2x3 = typename TF_data2x3<F_entry__, F_flag__>::F_passed_argument;

    NCPP_RTTI_CREATE_FLAG(F_data2x3_f32_flag);
    NCPP_RTTI_CREATE_FLAG(F_data2x3_i32_flag);
    NCPP_RTTI_CREATE_FLAG(F_data2x3_u32_flag);

    NCPP_RTTI_CREATE_FLAG(F_data2x3_f64_flag);
    NCPP_RTTI_CREATE_FLAG(F_data2x3_i64_flag);
    NCPP_RTTI_CREATE_FLAG(F_data2x3_u64_flag);
    ...
    using F_data2x3_f32 = TF_data2x3<f32>;
...
#define NMATH_DATA2X3_SIMD_M256() \
    __m256 ab_;
#define NMATH_DATA2X3_SIMD_CONSTRUCTOR_M256() \
    NCPP_FORCE_INLINE TF_data2x3(__m256 ab) : \
        ab_(ab)\
    {}
#else
#define NMATH_DATA2X3_SIMD_M256() ;
#define NMATH_DATA2X3_SIMD_CONSTRUCTOR_M256() ;
    ...
    struct NCPP_ALIGN(32) TF_data2x3<f32, F_flag__> {
        ...
        using F_this = TF_data2x3<F_entry, F_flag__>;
        ...
        NCPP_RTTI_IMPLEMENT_FLAG(TF_data2x3, nmath::F_data2x3_f32_flag);
        NCPP_RTTI_IMPLEMENT_FLAG(TF_data2x3, F_flag__);
        ...
        //  Basic constructors
        ////////////////////////////////////////////////////////////////////////////////////
        NCPP_FORCE_INLINE TF_data2x3() noexcept :
#ifdef NCPP_ENABLE_AVX
        ...
        NCPP_FORCE_INLINE TF_data2x3(const TF_data2x3& o) noexcept :
#ifdef NCPP_ENABLE_AVX
            ab_(o.ab_)
#else
            a(o.a),
        ...
        NMATH_DATA2X3_SIMD_CONSTRUCTOR_M256();
        ...
        //  Operators
        ////////////////////////////////////////////////////////////////////////////////////
        NCPP_FORCE_INLINE TF_data2x3& NCPP_VECTOR_CALL operator = (F_passed_argument o) noexcept
        {
        ...
        friend NCPP_FORCE_INLINE ncpp::b8 NCPP_VECTOR_CALL operator == (F_passed_argument a, F_passed_argument b) noexcept
        {
            ...
            return ((ab_mask | 0b10001000) == 0b11111111);
#else
    ...
    using PA_data2x3_f32 = TPA_data2x3<f32>;
