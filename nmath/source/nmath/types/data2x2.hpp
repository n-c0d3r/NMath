...
namespace nmath {
    ...
    template<typename F_entry__ = NMATH_DEFAULT_FP_TYPE, typename F_flag__ = F_data_default_flag>
    using TPA_data2x2 = typename TF_data2x2<F_entry__, F_flag__>::F_passed_argument;

    NCPP_RTTI_CREATE_FLAG(F_data2x2_f32_flag);
    NCPP_RTTI_CREATE_FLAG(F_data2x2_i32_flag);
    NCPP_RTTI_CREATE_FLAG(F_data2x2_u32_flag);

    NCPP_RTTI_CREATE_FLAG(F_data2x2_f64_flag);
    NCPP_RTTI_CREATE_FLAG(F_data2x2_i64_flag);
    NCPP_RTTI_CREATE_FLAG(F_data2x2_u64_flag);
...
#define NMATH_DATA2X2_SIMD_CONSTRUCTOR_M128() ;
    ...
    struct NCPP_ALIGN(16) TF_data2x2<f32, F_flag__> {
        ...
        //  Functions
        ////////////////////////////////////////////////////////////////////////////////////
        NCPP_FORCE_INLINE TF_data2x2<F_entry> data() const {
