...
/** @file nmath/types/data3_i32.hpp
*
*   Implement data3_i32.
*/
...
#define NMATH_DATA3_SIMD_CONSTRUCTOR_M128I() ;
	...
	struct NCPP_ALIGN(sizeof(i32) * 4) TF_data3<i32, F_flag__> {
	...
	NCPP_RTTI_IMPLEMENT_FLAG(nmath::F_data3_i32_flag);
	...
	NMATH_DEFINE_DATA3_I32_FORWARD(F_data3_i32)
