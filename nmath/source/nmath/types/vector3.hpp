...
namespace nmath {
    ...
    NMATH_DEFINE_DATA3_I32_FORWARD(F_vector3_i32);
    NMATH_DEFINE_DATA3_I32_REVERSE_FORWARD(vecma_forward, F_vector3_i32);
	NMATH_DEFINE_DATA3_U32_FORWARD(F_vector3_u32);
	NMATH_DEFINE_DATA3_U32_REVERSE_FORWARD(vecma_forward, F_vector3_u32);
