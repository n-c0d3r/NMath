...
namespace nmath {
    ...
    using F_data4x3_f32 = TF_data4x3<f32>;
...
#define NMATH_DATA4X3_SIMD_M256X2() \
    struct {\
        __m256 ab_;\
        __m256 cd_;\
    };
#define NMATH_DATA4X3_SIMD_CONSTRUCTOR_M256X2() \
    NCPP_FORCE_INLINE TF_data4x3(__m256 ab, __m256 cd) : \
        ab_(ab),\
        cd_(cd)\
    {}
#else
...
#define NMATH_DATA4X3_SIMD_CONSTRUCTOR_M256X2() ;
    ...
    struct NCPP_ALIGN(64) TF_data4x3<f32, F_flag__> {
        ...
        using F_this = TF_data4x3<F_entry, F_flag__>;
        ...
        NCPP_RTTI_IMPLEMENT_FLAG(TF_data4x3, nmath::F_data4x3_f32_flag);
        NCPP_RTTI_IMPLEMENT_FLAG(TF_data4x3, F_flag__);
        ...
        //  Basic constructors
        ////////////////////////////////////////////////////////////////////////////////////
        NCPP_FORCE_INLINE TF_data4x3() noexcept :
#ifdef NCPP_ENABLE_AVX
        ...
        NCPP_FORCE_INLINE TF_data4x3(F_pack a, F_pack b, F_pack c, F_pack d) noexcept :
#ifdef NCPP_ENABLE_AVX
            ab_(_mm256_set_m128(b.xyz_, a.xyz_)),
            cd_(_mm256_set_m128(d.xyz_, c.xyz_))
#else
            a(a),
            b(b),
            c(c),
        ...
        NCPP_FORCE_INLINE TF_data4x3(F_pack a, F_pack b, PA_data2x3 cd) noexcept :
#ifdef NCPP_ENABLE_AVX
            ab_(_mm256_set_m128(b.xyz_, a.xyz_)),
            cd_(cd.ab_)
#else
        ...
        NCPP_FORCE_INLINE TF_data4x3(F_pack a, PA_data2x3 bc, F_pack d) noexcept :
#ifdef NCPP_ENABLE_AVX
            ab_(_mm256_set_m128(bc.a.xyz_, a.xyz_)),
            cd_(_mm256_set_m128(d.xyz_, bc.b.xyz_))
#else
            a(a),
            b(bc.a),
            c(bc.b),
        ...
        NCPP_FORCE_INLINE TF_data4x3(PA_data2x3 ab, F_pack c, F_pack d) noexcept :
#ifdef NCPP_ENABLE_AVX
            ab_(ab.ab_),
            cd_(_mm256_set_m128(d.xyz_, c.xyz_))
#else
        ...
        NCPP_FORCE_INLINE TF_data4x3(PA_data2x3 ab, PA_data2x3 cd) noexcept :
#ifdef NCPP_ENABLE_AVX
            ab_(ab.ab_),
            cd_(cd.ab_)
#else
        ...
        NCPP_FORCE_INLINE TF_data4x3(PA_data3x3 abc, F_pack d) noexcept :
#ifdef NCPP_ENABLE_AVX
            ab_(abc.ab_),
            cd_(_mm256_set_m128(d.xyz_, abc.c_.xyz_))
#else
            a(abc.a),
            b(abc.b),
            c(abc.c),
        ...
        NCPP_FORCE_INLINE TF_data4x3(F_pack a, PA_data3x3 bcd) noexcept :
#ifdef NCPP_ENABLE_AVX
            ab_(_mm256_set_m128(bcd.a.xyz_, a.xyz_)),
            cd_(_mm256_set_m128(bcd.c.xyz_, bcd.b.xyz_))
#else
            a(a),
            b(bcd.a),
            c(bcd.b),
        ...
        NCPP_FORCE_INLINE TF_data4x3(const TF_data4x3& o) noexcept :
#ifdef NCPP_ENABLE_AVX
            ab_(o.ab_),
            cd_(o.cd_)
#else
        ...
        NMATH_DATA4X3_SIMD_CONSTRUCTOR_M256X2();
        ...
        //  Operators
        ////////////////////////////////////////////////////////////////////////////////////
        NCPP_FORCE_INLINE TF_data4x3& NCPP_VECTOR_CALL operator = (F_passed_argument o) noexcept
        {
        ...
        friend NCPP_FORCE_INLINE ncpp::b8 NCPP_VECTOR_CALL operator == (F_passed_argument a, F_passed_argument b) noexcept
        {
            ...
            return (((ab_mask | 0b10001000) & (cd_mask | 0b10001000)) == 0b11111111);
#else
        ...
        NCPP_FORCE_INLINE F_data2x3 ad() const {
        ...
        NCPP_FORCE_INLINE F_data2x3 bd() const {
        ...
        NCPP_FORCE_INLINE F_data2x3 cd() const {
        ...
        NCPP_FORCE_INLINE F_data2x3 da() const {
        ...
        NCPP_FORCE_INLINE F_data2x3 db() const {
        ...
        NCPP_FORCE_INLINE F_data2x3 dc() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 abc() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 abd() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 acb() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 acd() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 adb() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 adc() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 bac() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 bad() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 bca() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 bcd() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 bda() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 bdc() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 cab() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 cad() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 cba() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 cbd() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 cda() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 cdb() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 dab() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 dac() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 dba() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 dbc() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 dca() const {
        ...
        NCPP_FORCE_INLINE F_data3x3 dcb() const {
        ...
        NCPP_FORCE_INLINE TF_data4x3<F_entry> NCPP_VECTOR_CALL data4x3() const {
        ...
        template<typename F_another_data4x3__>
        NCPP_FORCE_INLINE TF_data_cast<F_another_data4x3__> T_data4x3() const {
    ...
    using PA_data4x3_f32 = TPA_data4x3<f32>;
