...
namespace nmath {
    ...
    NMATH_DEFINE_DATA2_I32_FORWARD(F_vector2_i32);
    NMATH_DEFINE_DATA2_I32_REVERSE_FORWARD(vecma_forward, F_vector2_i32);

    NMATH_DEFINE_DATA2_U32_FORWARD(F_vector2_u32);
    NMATH_DEFINE_DATA2_U32_REVERSE_FORWARD(vecma_forward, F_vector2_u32);
