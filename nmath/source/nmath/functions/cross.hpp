...
namespace nmath {	
	...
	NCPP_FORCE_INLINE F_vector4_f32 NMATH_CALL_CNV cross(PA_vector4_f32 a, PA_vector4_f32 b, PA_vector4_f32 c) noexcept {

		return vecma_forward(
			data4_cross(data_forward(a), data_forward(b), data_forward(c))
		);
	}
	NCPP_FORCE_INLINE F_quaternion_f32 NMATH_CALL_CNV cross(PA_quaternion_f32 a, PA_quaternion_f32 b, PA_quaternion_f32 c) noexcept {
